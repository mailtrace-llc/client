<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <h3 id="mapper-title" class="text-lg font-semibold mb-2">
          Mapping required
        </h3>
        <p class="text-sm text-neutral-600 dark:text-neutral-300 mb-4">
          We couldn’t start the run because some required columns aren’t mapped
          yet.
        </p>
        ...
        <div class="flex gap-2 justify-end">
          ...
          <button class="btn" @click="edit">\1</button>
        </div>
      </div>
    </div>
  </Teleport>
