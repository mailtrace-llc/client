...
function onKey(e: KeyboardEvent) {
  ...
  // Simple focus trap: keep focus on dialog when Tab cycles
  if (e.key === 'Tab') {
    e.preventDefault()
    ...
    <transition name="fade-fast">
      ...
      >
        <div
          ref="dialogEl"
          tabindex="-1"
          class="relative flex h-[510px] w-[420px] items-center justify-center overflow-hidden rounded-[28px] outline-none"
        ...
        >
          ...
          <div class="scene pointer-events-none select-none">
          ...
          <div class="absolute left-8 right-8 bottom-12">
            <div class="h-[10px] w-full overflow-hidden rounded-full"
                 style="background:rgba(255,255,255,0.08); box-shadow: inset 0 0 0 1px rgba(255,255,255,.06);">
              <div :style="{ width: pct }"
...
<style scoped>
/* quick fade so it doesn’t “pop” */
.fade-fast-enter-from,
.fade-fast-leave-to { opacity: 0 }
.fade-fast-enter-active,
.fade-fast-leave-active { transition: opacity .12s linear }
</style>